...
namespace MonoGamers
{
    ...
    public class TGCGame : Game
    {
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            // Para trasladarse entre checkpoints
            if (keyboardState.IsKeyDown(Keys.D1) && godMode)
            {
                sphereBody.Pose = new NumericVector3(Checkpoints[0].Position.X, Checkpoints[0].Position.Y + 10f, Checkpoints[0].Position.Z);
            }
            if (keyboardState.IsKeyDown(Keys.D2) && godMode)
            {
                sphereBody.Pose = new NumericVector3(Checkpoints[1].Position.X, Checkpoints[1].Position.Y + 10f, Checkpoints[1].Position.Z);
            }
            if (keyboardState.IsKeyDown(Keys.D3) && godMode)
            {
                sphereBody.Pose = new NumericVector3(Checkpoints[2].Position.X, Checkpoints[2].Position.Y + 10f, Checkpoints[2].Position.Z);
            }
            if (keyboardState.IsKeyDown(Keys.D4) && godMode)
            {
                sphereBody.Pose = new NumericVector3(Checkpoints[3].Position.X, Checkpoints[3].Position.Y + 10f, Checkpoints[3].Position.Z);
            }
